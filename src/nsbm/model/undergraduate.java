...
public class undergraduate {
    ...
    public undergraduate(String id,String gpa,String rank, String year,String sub1name,String sub2name,String sub3name, String sub4name,String sub1grade,String sub2grade,String sub3grade,String sub4grade ){
        this.id = id;
        this.gpa = gpa;
        this.rank = rank;
        this.year = year;
